...
public static class Server_ASP_NET_VANL
{
                ...
                webBuilder =>
                {
                    webBuilder.UseKestrel(
                        o =>
                        {
                            ...
                            o.Listen(new System.Net.IPAddress(new byte[] {10, 10, 4, 163}), 5001, l => l.UseMqtt());

                            // This will allow MQTT connections based on HTTP WebSockets with URI "localhost:5000/mqtt"
                            // See code below for URI configuration.
                            o.Listen(new System.Net.IPAddress(new byte[] {10, 10, 4, 163}), 9001); // Default HTTP pipeline
                        });
    ...
    sealed class MqttControllerVANL
    {
        ...
        static readonly string discordWebhook = "https://discord.com/api/webhooks/1192795355998330892/1R3Lic4souDscjofwWA7MrYFVcIYvKh9cutcatb8dagYfwIGKrgI84JFyEaZj90WnsDR";
